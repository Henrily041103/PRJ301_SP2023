                ...
                <div class="container w-100" style="width: 50rem;">  
                    ...
                    <div class="card-body">
                        ...
                        <div class="mt-3 d-flex justify-content-between">
                            <a href="<c:url value="/toy/edit.do?id=${toy.id}" />" class="btn btn-outline-warning"> Edit</a> 
                            <a href="<c:url value="/toy/delete.do?id=${toy.id}" />" class="btn btn-outline-danger"> Delete</a>
                        </div>
                    </div>
                </div>
            </div>
...
<c:if test="${currentPage != 1}">
    <td><a href="indexAd.do?page=${currentPage - 1}">Previous</a></td>
</c:if>
    ...
    <tr>
        <c:forEach begin="1" end="${noOfPages}" var="i">
            <c:choose>  
                ...
                <c:otherwise>
                    <td><a href="indexAd.do?page=${i}">${i}</a></td>
                    </c:otherwise>
                </c:choose>
            </c:forEach>
    </tr>
...
<c:if test="${currentPage lt noOfPages}">
    <td><a href="indexAd.do?page=${currentPage + 1}">Next</a></td>
</c:if>
