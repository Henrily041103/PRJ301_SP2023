...
<div class="row">
    <div class="col">
        <form action="<c:url value="/create_handler.do" />">
            ...
            <div class="mb-3">
                <label for="sale" class="form-label">Stock</label>
                <input type="number" step="1" class="form-control" id="stock" placeholder="Product stock" name="stock" value="${product.stock}">
            </div>
            <div class="mb-3">
                <label for="ageGroup" class="form-label">Age group</label>
                <input type="number" step="1" class="form-control" id="age-group" placeholder="Product age group" name="ageGroup" value="${product.ageGroup}">
            </div>
            <div class="mb-3">
